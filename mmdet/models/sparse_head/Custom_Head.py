...
class Custom_Head(BaseModule):
    ...
    def __init__(
        ...
        # self.generate_mask = Generate_Mask(self.in_channels, self.strides)
    ...
    def forward(self, x: tuple[Tensor]) -> Tuple[List[Tensor], ...]:
        ...
        return multi_apply(self.forward_single, x, self.scales, self.index)

    def forward_single(self, x: Tensor, scales: Scale, ind: int):
        ...
        if ind == 0 and self.feature_enhancement is not None:
            mask = self.feature_enhancement(x)
        ...
        centerness_pred = self.conv_centerness(cls_feat)
        ...
        return cls_score, bbox_pred, centerness_pred
    ...
    def loss(self, x: tuple[Tensor], batch_data_samples: SampleList) -> dict:
        ...
        if self.feature_enhancement is not None:
            losses.update(self.feature_enhancement.loss(x[0].unsqueeze(0), batch_gt_instances))
