...
class SingleStageDetector(BaseDetector):
    ...
    def __init__(self,
                 ...
                 dehazing_network: OptConfigType = None,
        ...
        if dehazing_network is not None:
            self.dehazing_network = MODELS.build(dehazing_network)
        else:
            self.dehazing_network = None
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        """
        losses = dict()
        if self.dehazing_network is not None:
            batch_inputs = self.dehazing_network(batch_inputs)
