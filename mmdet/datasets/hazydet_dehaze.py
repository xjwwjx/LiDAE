...
class HazyDetDataset_Dehaze(CocoDataset):
    ...
    def parse_data_info(self, raw_data_info: dict) -> Union[dict, List[dict]]:
        ...
        if self.data_prefix.get('clean_img', None):
            clean_img_path = osp.join(self.data_prefix['clean_img'], img_info['file_name'])
        else:
            clean_img_path = None
        ...
        data_info['clean_img_path'] = clean_img_path
